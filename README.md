 ...
 * Miscellaneous
    ...
    - Re-categorized external Java sample Op Modes to "TeleOp" instead of "AtticFanaticsRoverRuckusPrograms.AutonomousMechanumDogeCVNew.Autonomous".
 ...
 * Blocks Changes
     ...
     - AtticFanaticsRoverRuckusPrograms.AutonomousMechanumDogeCVNew.Autonomous op modes should no longer get switched back to tele-op after re-opening them to be edited.
 ...
 * Fix to reset AtticFanaticsRoverRuckusPrograms.AutonomousMechanumDogeCVNew.Autonomous timer back to 30 seconds.
...
Version 2.4 (released on 16.11.13)
  ...
  * Blocks Programming mode changes:
     ...
     - Added support for OpMode flavor (“AtticFanaticsRoverRuckusPrograms.AutonomousMechanumDogeCVNew.Autonomous” or “TeleOp”) and group.
